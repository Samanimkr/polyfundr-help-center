...
<Info>You need an active challenge or funded account to submit trades. If you don't have one, visit `/accounts` to buy a challenge, or try the free demo account to get familiar with the trade panel first.</Info>
