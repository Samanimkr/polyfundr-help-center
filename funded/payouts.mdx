...
From there each request is still the lower of the two limits above, the ladder
and your eligible net, with a 7-day cooldown between requests. The ladder caps
